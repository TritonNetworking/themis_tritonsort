...
def main():
    ...
    log_directory = os.path.join(log_directory, "mixediobench")

    parser = argparse.ArgumentParser(
        description="Harness for mixed I/O benchmark application")
    parser.add_argument(
    ...
    binary = os.path.join(BENCHMARK_DIR, "mixediobench")
    solo_mode = False
    stage_stats = "reader,sender,receiver,writer"
